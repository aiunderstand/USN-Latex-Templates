...
% --- Useful packages ---
\usepackage[
	photo={images/bolger.jpg}, % Optional
%    description={},% Optional
    %
    %
    %
%   logo= % Defaults to a vectorized version of USN logo
...
\include{sections/1_dedication.tex}
\include{sections/2_preface.tex}
\include{sections/3_abstract.tex}
\include{sections/4_toc_figures_tables_nomenclature.tex}
\include{sections/5_H1_Introduction}  
\include{sections/6_H2_Theory}
\include{sections/7_H3_Methods} 
\include{sections/8_H4_Results}
\include{sections/9_H5_Discussion}
\include{sections/10_H6_Conclusion}
